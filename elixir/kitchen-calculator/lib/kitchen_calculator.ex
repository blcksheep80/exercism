defmodule KitchenCalculator do
  def get_volume(volume_amount), do: Kernel.elem(volume_amount, 1)
  ...
  def convert({inital_unit, volume}, unit) do
    {unit, get_volume({inital_unit, volume}) * get_volume({unit, volume})}
  end
end
